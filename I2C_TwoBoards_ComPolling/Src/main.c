...
{    
  ...
  while(1)
  {
  while(HAL_I2C_Mem_Read(&I2cHandle, I2C_SLAVEADDRESS, 0x3B, 2, (uint8_t*)aRxBuffer, TXBUFFERSIZE, 10000) != HAL_OK);
  if (HAL_I2C_GetError(&I2cHandle) != HAL_I2C_ERROR_AF) Error_Handler();
